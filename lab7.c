// WindowsProject12.cpp : Определяет точку входа для приложения.
//
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINDOWSPROJECT12);
    ...
    case WM_PAINT:
        {
            ...
            //забор
            hPen = CreatePen(PS_SOLID, 2, RGB(200, 0, 200));
            SelectObject(hdc, hPen);
            {
                int x1 = 150, y1 = 0;
                int x2 = 150, y2 = 100;
